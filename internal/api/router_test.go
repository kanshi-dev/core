...
func TestHealth(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			response, err := NewServer(nil, nil, nil, nil, tt.ping, "dashboard-secret", "").App.Test(
...
func TestAPIAuthenticationAndCORS(t *testing.T) {
	app := NewServer(nil, nil, nil, nil, nil, "dashboard-secret", "https://dashboard.example.com").App
